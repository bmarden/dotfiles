...
local scheme = wezterm.color.get_builtin_schemes()['One Dark (Gogh)']
scheme.background = '#111317'
scheme.cursor_bg = '#61afef'
scheme.foreground = '#6b7280'
-- scheme.brights[1] = '#4b52d3'
config.color_schemes = {
  ['One Dark (Gogh)'] = scheme,
}
